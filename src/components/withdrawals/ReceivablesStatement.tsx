  ...
  return (
    <div className="rounded-xl bg-[#111820] border border-[#1e2a3a]">
      <div className="p-6 border-b border-[#1e2a3a]">
        <h2 className="text-lg font-semibold text-white">Extrato de Recebimentos</h2>
        <p className="text-sm text-gray-400">Recebimentos agrupados por data</p>
      </div>
...
export default ReceivablesStatement;
